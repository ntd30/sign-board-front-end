...
const DesignTable = (props) => {
    const { dataDesigns, loadDesigns, current, setCurrent, pageSize, setPageSize, total, loadingTable, permissionsOfCurrentUser, searchTerm, setSearchTerm } = props;
    ...
    const columns = [
        ...
        },
        {
            title: 'Trạng thái',
            dataIndex: 'status',
            render: (value) => DesignRepository.getStatusText(value),
            width: 150,
        },
        {
            title: 'Action',
    ...
    return (
        <>
            <div style={{ marginBottom: 16 }}>
                <Search
                    placeholder="Tìm kiếm theo tên người sở hữu, email, số điện thoại, trạng thái hoặc mô tả"
                    allowClear
